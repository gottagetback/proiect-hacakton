...
export function TrafficMap() {
  const center = { lat: 44.4375, lng: 26.0973 }; // centru București
      ...
      <CardContent style={{ flex: 1, padding: 0, position: "relative" }}>
        ...
        <div style={{ position: "absolute", top: 16, left: 16, right: 16, display: "flex", justifyContent: "space-between", zIndex: 10 }}>
          <div style={{ backgroundColor: "rgba(255,255,255,0.95)", padding: 8, borderRadius: 8, boxShadow: "0 0 6px rgba(0,0,0,0.1)" }}>
            <h3 style={{ fontSize: 12, fontWeight: 600 }}>Harta Trafic - București</h3>
            <p style={{ fontSize: 10, color: "#555" }}>Monitorizare în timp real</p>
          </div>
          <div style={{ display: "flex", gap: 8 }}>
            <Button size="icon" variant="outline" style={{ height: 32, width: 32 }}>
              {" "}
              <ZoomIn size={16} />{" "}
            </Button>
            <Button size="icon" variant="outline" style={{ height: 32, width: 32 }}>
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
              ...
              <span style={{ fontSize: 10 }}>Aglomerat</span>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
              <div style={{ width: 10, height: 10, borderRadius: "50%", backgroundColor: "#EF4444" }} />
              <span style={{ fontSize: 10 }}>Congestionat</span>
            </div>
          </div>
        </div>
      </CardContent>
